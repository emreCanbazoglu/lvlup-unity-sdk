...
{
    /// <summary>
    /// HTTP service for Remote Config API communication
    /// Should be managed by LvlUpManager, not used as standalone
    /// </summary>
    public class RemoteConfigService
    {
        ...
        /// <summary>
        /// Creates a Remote Config service instance
        /// Note: This should be initialized and managed by LvlUpManager
        /// </summary>
        public RemoteConfigService(string baseUrl, string gameId, float timeout = 30f, bool debugLogs = false)
        {
