...
namespace LvlUp
{
    ...
    public class LvlUpManager : MonoBehaviour
    {
        ...
        private void InitializeServices(string remoteConfigEnvironment)
        {
            ...
            _remoteConfigService.Initialize(_httpClient, remoteConfigEnvironment, _config.enableDebugLogs, _config.logRemoteConfigResult);
        ...
        {
            _revenueTrackingService.TrackInAppPurchase(productId, revenue, currency, revenueUSD, transactionId, store, productName, productType, quantity, isVerified);
        }
